...
export const ProductDetailPage = ({ product, relatedProducts = [], loading = false }) => {
  const {
    title,
    // link,
    image,
  ...
  const selectedQuantity = mainStore.getSelectedQuantity();
          ...
          <div class="border-t border-gray-200 p-4">
            <div class="flex items-center justify-between mb-4">
              ...
              <div class="flex items-center">
                ...
                <input type="number" id="quantity-input" value="${selectedQuantity}" min="1" max="10" class="w-16 h-8 text-center text-sm border-t border-b border-gray-300 
